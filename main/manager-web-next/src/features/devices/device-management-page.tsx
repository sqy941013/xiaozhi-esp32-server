          ...
          <table className="w-full min-w-[1080px] text-left text-sm">
            <thead className="border-b bg-muted/30 text-xs text-muted-foreground">
              <tr>
                ...
                <th className="px-4 py-3">{t("agentCenter.device.alias")}</th>
