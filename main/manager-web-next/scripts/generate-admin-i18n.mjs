...
const outputFile = path.resolve(
  projectRoot,
  "src/i18n/legacy-admin-resources.generated.ts",
);
...
const output = `// Generated from the legacy Vue locale files. Run pnpm i18n:admin:generate after locale changes.\nexport const legacyAdminResources = ${JSON.stringify(resources, null, 2)} as const;\n`;
