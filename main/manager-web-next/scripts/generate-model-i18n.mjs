...
const outputFile = path.resolve(
  projectRoot,
  "src/i18n/legacy-model-resources.generated.ts",
);
...
const output = `// Generated from the legacy Vue locale files. Run pnpm i18n:model:generate after locale changes.\nexport const legacyModelResources = ${JSON.stringify(resources, null, 2)} as const;\n`;
